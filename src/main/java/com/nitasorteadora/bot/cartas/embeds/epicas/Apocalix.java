package com.nitasorteadora.bot.cartas.embeds.epicas;
...
public class Apocalix {
    public static void Apocalix(CommandEvent commandEvent){
        CartaC carta = CartaC.APOCALIX;
