package com.nitasorteadora.bot.cartas.embeds.comunes;
...
public class Janethy {
    public static void Janethy(CommandEvent commandEvent) {
        CartaC carta = CartaC.JANETHY;
