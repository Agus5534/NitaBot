...
public class Salvadorsss {
    public static void Salvi(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2021,11,2,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2022,11,2,0,0, 0);
            ...
            eb.setTitle("Cumples de Salvador:");
