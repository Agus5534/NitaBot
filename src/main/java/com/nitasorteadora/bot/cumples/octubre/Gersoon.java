...
public class Gersoon {
    public static void Gerson(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2021,10,18,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2022,10,18,0,0, 0);
            ...
            eb.setTitle("Cumples de Gersoon:");
