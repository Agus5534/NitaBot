...
public class Zijhyan {
    public static void Zij(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2021,10,3,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2022,10,3,0,0, 0);
            ...
            eb.setTitle("Cumples de Zijhyan:");
