package com.nitasorteadora.bot.cumples.febrero;
...
public class Cuchiuwu {
    public static void Cuchi(CommandEvent commandEvent) {
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,2,7,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,2,7,0,0, 0);
