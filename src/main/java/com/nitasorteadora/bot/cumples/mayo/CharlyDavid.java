...
public class CharlyDavid {
    public static void Charly(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,5,19,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,5,19,0,0, 0);
