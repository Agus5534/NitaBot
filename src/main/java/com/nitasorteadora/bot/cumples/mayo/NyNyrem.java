package com.nitasorteadora.bot.cumples.mayo;
...
public class NyNyrem {
    public static void Nyrem(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,5,5,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,5,5,0,0, 0);
