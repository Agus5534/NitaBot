package com.nitasorteadora.bot.cumples.septiembre;
...
public class TheJuanjo {
    public static void Juanjo(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2021,9,10,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2022,9,10,0,0, 0);
