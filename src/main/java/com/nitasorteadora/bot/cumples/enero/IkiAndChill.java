package com.nitasorteadora.bot.cumples.enero;
...
public class IkiAndChill {
    public static void Iki(CommandEvent commandEvent) {
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,1,2,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,1,2,0,0, 0);
