...
public class MrComeGatos {
    public static void ComeGatos(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,6,28,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,6,28,0,0, 0);
            ...
            eb.setTitle("Cumples de MrComeGatos:");
