package com.nitasorteadora.bot.cumples.junio;
...
public class Niita {
    public static void Nita(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,6,15,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,6,15,0,0, 0);
