...
public class Starrzfall {
    public static void Star(CommandEvent commandEvent) {
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,3,4,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,3,4,0,0, 0);
