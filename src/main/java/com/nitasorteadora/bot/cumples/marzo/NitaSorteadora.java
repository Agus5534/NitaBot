package com.nitasorteadora.bot.cumples.marzo;
...
public class NitaSorteadora {
    public static void NitaSorteadora(CommandEvent commandEvent) {
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,3,2,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,3,2,0,0, 0);
            ...
            eb.setTitle("Cumples de NitaSorteadora:");
