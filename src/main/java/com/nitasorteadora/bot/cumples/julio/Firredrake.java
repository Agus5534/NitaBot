package com.nitasorteadora.bot.cumples.julio;
...
public class Firredrake {
    public static void Firre(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,7,25,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,7,25,0,0, 0);
