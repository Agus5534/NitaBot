...
public class Maurito {
    public static void Mauri(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,7,22,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,7,22,0,0, 0);
            ...
            eb.setTitle("Cumples de Maurito:");
