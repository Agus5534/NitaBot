package com.nitasorteadora.bot.cumples.abril;
...
public class Juuzouv5 {
    public static void Juzo(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,4,5,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,4,5,0,0, 0);
