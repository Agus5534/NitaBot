package com.nitasorteadora.bot.cumples.diciembre;
...
public class TheBoyPanda {
    public static void Panda(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2021,12,20,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2022,12,20,0,0, 0);
