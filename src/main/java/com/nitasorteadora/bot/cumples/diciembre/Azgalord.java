...
public class Azgalord {
    public static void Azga(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2021,12,4,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2022,12,4,0,0, 0);
            ...
            eb.setTitle("Cumples de Azgalord:");
