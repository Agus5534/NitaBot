package com.nitasorteadora.bot.cumples.agosto;
...
public class PatoLand {
    public static void Pato(CommandEvent commandEvent){
        final LocalDateTime now = LocalDateTime.now();
        final LocalDateTime tb = LocalDateTime.of(2022,8,13,0,0, 0);
        ...
        if(now.isAfter(tb)) {
            ...
            final LocalDateTime tb2 = LocalDateTime.of(2023,8,13,0,0, 0);
